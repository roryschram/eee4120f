...
#
# Generated by Vivado on Fri Apr 28 10:20:43 SAST 2023
...
compile()
{
  ...
  vlogan -work blk_mem_gen_v8_4_4 $vlogan_opts +v2k \
    "$ref_dir//home/SCHROR002/Xilinx/Practical_3_2/Prac3_2_Code/prac3_2_code.srcs/sources_1/ip/blk_mem_gen_0/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/SCHROR002/Xilinx/Practical_3_2/Prac3_2_Code/prac3_2_code.cache/compile_simlib/vcs"
  fi
